...
predefined_lms = {
    ...
    "chainer": {
        "default": "espnet.lm.chainer_backend.lm.default:DefaultRNNLM",
        "seq_rnn": "espnet.lm.chainer_backend.lm.seq_rnn:SequentialRNNLM",
        "transformer": "espnet.lm.chainer_backend.lm.transformer:TransformerLM",
    }
}
