...
from espnet.nets.chainer_backend.transformer_stream import ctc

from espnet.nets.chainer_backend.transformer_stream.attention import MultiHeadAttention
from espnet.nets.chainer_backend.transformer_stream.decoder import Decoder
from espnet.nets.chainer_backend.transformer_stream.encoder import Encoder
from espnet.nets.chainer_backend.transformer_stream.label_smoothing_loss import LabelSmoothingLoss
...
class E2E(ChainerASRInterface):
    ...
    def custom_converter(subsampling_factor=0):
        ...
        from espnet.nets.chainer_backend.transformer_stream.training import CustomConverter
        return CustomConverter()

    @staticmethod
    def custom_updater(iters, optimizer, converter, device=-1, accum_grad=1):
        """Get custom_updater of the model."""
        from espnet.nets.chainer_backend.transformer_stream.training import CustomUpdater
    ...
    def custom_parallel_updater(iters, optimizer, converter, devices, accum_grad=1):
        ...
        from espnet.nets.chainer_backend.transformer_stream.training import CustomParallelUpdater
