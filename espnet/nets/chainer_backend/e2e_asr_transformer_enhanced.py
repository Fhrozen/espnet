...
from espnet.nets.chainer_backend.transformer_enhanced.attention import MultiHeadAttention
from espnet.nets.chainer_backend.transformer_enhanced.decoder import Decoder
from espnet.nets.chainer_backend.transformer_enhanced.encoder import Encoder
...
class E2E(ASRInterface, chainer.Chain):
    ...
    def add_arguments(parser):
        ...
        group.add_argument('--enhanced', default=false, type=strtobool,
                           help='Enable the use of enhanced transformer')
        return parser
