...
if [ ${stage} -le 1 ]; then
    ...
    dump.sh --cmd "$train_cmd" --nj 32 --do_delta $do_delta \
        data/${mic}_train/feats.scp data/${mic}_train/cmvn.ark exp/dump_feats/train ${dumpdir}/${mic}_train/delta${do_delta}
    dump.sh --cmd "$train_cmd" --nj 32 --do_delta $do_delta \
        data/${mic}_train_speed/feats.scp data/${mic}_train/cmvn.ark exp/dump_feats/train ${dumpdir}/${mic}_train_speed/delta${do_delta}
...
if [ ${stage} -le 2 ]; then
    ...
    # make json labels
    data2json.sh --feat ${dumpdir}/${mic}_train/delta${do_delta}/feats.scp \
         data/${mic}_train ${dict} > ${dumpdir}/${mic}_train/delta${do_delta}/data.json
    data2json.sh --feat ${dumpdir}/${mic}_train_speed/delta${do_delta}/feats.scp \
         data/${mic}_train_speed ${dict} > ${dumpdir}/${mic}_train_speed/delta${do_delta}/data.json
