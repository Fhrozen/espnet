...
if ${eval_flag}; then
list_set="tr05_real_noisy_${tag} dt05_real_noisy_${tag} et05_real_noisy_${tag}"
else
list_set="tr05_real_noisy_${tag} dt05_real_noisy_${tag}"
fi
...
awk '{print}{sub(/CH1/, "CH2",$0);print}{sub(/CH2/, "CH3",$0);print}{sub(/CH3/, "CH4",$0);print}{sub(/CH4/, "CH5",$0);print}{sub(/CH5/, "CH6",$0);print}' | \
sort -k 1 > et05_real_noisy_${tag}.trans1
fi
